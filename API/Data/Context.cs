...
namespace API.Data
{
    public class Context : DbContext
    {
        ...
        {
            _provider = new GenerateEncryptionProvider("5a9bb31a2e56e9c119e9c167f88c2383");
        }

        // Tablas a crearse en la BBDD
        public DbSet<User> Users { get; set; }
        public DbSet<BookCategory> BookCategories { get; set; }
        public DbSet<Book> Books { get; set; }
        public DbSet<Order> Orders { get; set; }

        // Al momento de la creacion de las tablas, podemos cargar datos iniciales
